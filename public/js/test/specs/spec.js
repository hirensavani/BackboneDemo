...
define(["jquery", "backbone", "text!templates/heading.html", "collections/Photos", "models/Photo", "views/View", "views/Details", "routers/DesktopRouter", "jasminejquery", "sinon"],

    function($, Backbone, headerText, Collection, Model, View, Details, DesktopRouter, MobileRouter) {
        describe("Backbone-Require-Boilerplate (BRB)", function() {
             // Backbone View Suite: contains all tests related to views
             describe("Backbone views", function() {
                ...
                it("Main view should contain the correct view element", function() {
            ...
            describe("Backbone views", function() {
                ...
                beforeEach(function() {
                    ...
                    // Instantiates a new View instance               
                    this.detialsView = new Details();
                     

                });

                it("Details view should contain the correct view element", function() {

                    this.router = new DesktopRouter();

                    expect(this.detialsView.$el.selector).toEqual(".example");

                });

                it("Details view should have only one Image", function() {
